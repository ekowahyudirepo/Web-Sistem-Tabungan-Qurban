	    ...
	    <div id="content">
	    	...
	    	<div class="card">
	    		<div class="card-body">
			    	...
			    	<form action="<?php echo base_url() ?>admin/info__up/tentang" method="POST">
					<div class="row">
						<div class="col-md-12">
							<fieldset class="form-group">
								<label>Tentang</label>
								<textarea id="summernote" class="form-control" rows="20" name="TENTANG"><?php echo $info->INFO_TENTANG; ?></textarea>
							</fieldset>
