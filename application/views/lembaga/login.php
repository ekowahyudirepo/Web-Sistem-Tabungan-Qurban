...
<html lang="en">
	...
	<div class="bxlogin">
		...
		<div class="card">
			<div class="card-body">
				<h2 class="text-primary"><b>MASUK LEMBAGA</b></h2>
				<br>
				<form action="<?php echo base_url() ?>lembaga/lembaga__masuk" method="POST">
					<fieldset class="form-group">
						<label>Email</label>
						<input type="email" class="form-control" placeholder="Enter Email" name="EMAIL" tabindex="1" required="" autofocus="">
					</fieldset>
					<fieldset class="form-group">
					...
					<br>
					<button type="submit" class="btn btn-primary btn-lg btn-block"><i class="icon icon-login"></i> Masuk</button>
